 ...
 : State(game)
{
   ...
   m_playButton = new Button(ResourcesManager::GetTexture("assets/ui/button.png"), "Play",
   ...
   m_creditsButton = new Button(ResourcesManager::GetTexture("assets/ui/button.png"), "Credits",
                             ResourcesManager::GetFont("assets/fonts/pixel.ttf"), ResourcesManager::GetShader("text"));
